...
namespace Hooks
{
    // Function specifically for patching the strength cap CMOV instruction for Hand to Hand
    void InstallHandToHandStrengthCapPatch()
    {
        // --- Configuration ---
    ...
    // Function specifically for patching the strength cap CMOV instruction for Weapons
    void InstallWeaponsStrengthCapPatch()
    {
        // --- Configuration ---
        // Offset of the CMOV instruction (0F 4F D8) from the Oblivion.exe base address.
        // Example: If Ghidra shows base 140000000 and instruction at 14684a835,
        // the offset is 14684a835 - 140000000 = 0x684a835.
        constexpr REL::Offset instructionOffset(0x684AAD7);
    ...
    void Install()
    {
        ...
        InstallHandToHandStrengthCapPatch();
        InstallWeaponsStrengthCapPatch();
    }
